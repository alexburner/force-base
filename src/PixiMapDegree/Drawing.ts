...
import { D3Colors } from 'src/PixiMapDegree/constants'
import { Node, Link } from 'src/PixiMapDegree/interfaces'
import { colorToHex, makeCanvas } from 'src/PixiMapDegree/util'
...
export default class Drawing {
    ...
    update(nodes: Node[], links: Link[]) {
        ...
        _.each(nodes, node => {
            ...
            sprite.scale.x = (node.scale + 0.3) * 0.08 // magic #
            sprite.scale.y = (node.scale + 0.3) * 0.08 // magic #
