...
import Drawing from 'src/PixiMapDegree/Drawing'
import WorkerLoader from 'worker-loader!src/PixiMapDegree/worker'
import {
    Edge,
    Node,
    Link,
    ...
    LinksById,
    Opts,
} from 'src/PixiMapDegree/interfaces'
import { makeNode, makeLink, makeScales } from 'src/PixiMapDegree/util'
