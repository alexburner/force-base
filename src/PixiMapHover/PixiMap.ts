...
import Drawing from 'src/PixiMapHover/Drawing'
import WorkerLoader from 'worker-loader!src/PixiMapHover/worker'
import {
    Edge,
    Node,
    Link,
    ...
    LinksById,
    Opts,
} from 'src/PixiMapHover/interfaces'
import { makeNode, makeLink, makeScales } from 'src/PixiMapHover/util'
